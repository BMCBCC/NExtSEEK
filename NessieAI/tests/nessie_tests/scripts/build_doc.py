...
W("")
W("The corpus edit is staged in `NessieAI/tests/nessie_tests/corpus.json` on this branch and the unit")
W("suite is green (**1215 passed, 28 skipped**; baseline 1216/28 — see §9). Reverting is")
W("`git checkout NessieAI/tests/nessie_tests/corpus.json`.")
W("")
W("---")
W("")
...
W("  python -m pytest NessieAI/tests/nessie_tests/tests -q -p no:cacheprovider")
W("```")
W("")
