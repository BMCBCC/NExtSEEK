...
class TestIngestSchemaErrorPaths:
    ...
    @patch("NessieAI.schema_rag.service.cleanup_expired_sessions")
    @patch("NessieAI.schema_rag.service.OpenAPISchemaProcessor")
    ...
    @patch("NessieAI.schema_rag.service.flatten_endpoints", side_effect=Exception("bad endpoints"))
    @patch("NessieAI.schema_rag.service.cleanup_expired_sessions")
    @patch("NessieAI.schema_rag.service.OpenAPISchemaProcessor")
    ...
    @patch("NessieAI.schema_rag.service.flatten_endpoints")
    @patch("NessieAI.schema_rag.service.cleanup_expired_sessions")
    @patch("NessieAI.schema_rag.service.OpenAPISchemaProcessor")
    ...
    @patch("NessieAI.schema_rag.service.create_session", side_effect=Exception("session error"))
    @patch("NessieAI.schema_rag.service.settings")
    @patch("NessieAI.schema_rag.service.flatten_endpoints")
    @patch("NessieAI.schema_rag.service.cleanup_expired_sessions")
    @patch("NessieAI.schema_rag.service.OpenAPISchemaProcessor")
    ...
    @patch("NessieAI.schema_rag.service.insert_endpoints", side_effect=Exception("insert error"))
    @patch("NessieAI.schema_rag.service.init_session_db")
    @patch("NessieAI.schema_rag.service.create_session")
    @patch("NessieAI.schema_rag.service.settings")
    @patch("NessieAI.schema_rag.service.flatten_endpoints")
    @patch("NessieAI.schema_rag.service.cleanup_expired_sessions")
    @patch("NessieAI.schema_rag.service.OpenAPISchemaProcessor")
    ...
    @patch("NessieAI.schema_rag.service.insert_endpoints")
    @patch("NessieAI.schema_rag.service.init_session_db")
    @patch("NessieAI.schema_rag.service.create_session")
    @patch("NessieAI.schema_rag.service.settings")
    @patch("NessieAI.schema_rag.service.flatten_endpoints")
