...
| Label | Covers |
|---|---|
| `area: cc_assistant` | Container-CC: NessieAI/cc/, its Django shell nextseek_api/cc_assistant/, NessieAI/docker/cc-runtime/, agent plugin+skills |
...
| `area: schema-rag` | schema-aware retrieval that grounds NL queries against the live API's OpenAPI schema (`NessieAI/schema_rag/`) |
