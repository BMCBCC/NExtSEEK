...
urlpatterns = i18n_patterns(
    #url(r'^accounts/login/$', views.custom_login, name='custom_login'),
    ...
    #url(r'^alumnidb/$', 'data.views.alumnidb', name='alumnidb'),
    #url(r'^alumnidb/$', 'djangocms.data.views.alumnidb'),
    #url(r'^alumnidb/$', 'views.alumnidb', name='alumnidb'),
    #url(r'', include('vewTrak.urls')),
...
urlpatterns += [
    ...
    # this is to redirect the default Django login by the custome Seek login 
